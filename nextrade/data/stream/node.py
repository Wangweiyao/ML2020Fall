...
from nextrade.base.core import Observable
...
class Node(Observable):
    ...
    def residual(self, divider) -> 'Node':
        name = "Residual({}{})".format(self.name, divider)
        return self.apply(lambda x: (x % divider)/divider - 0.5).rename(name)
