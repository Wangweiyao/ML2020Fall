...
from nextrade.environments.render import BaseRenderer
from nextrade.environments.utils.helpers import create_auto_file_name, check_path


class PlotlyTradingChart(BaseRenderer):
    """
    Trading visualization for nextrade using Plotly.
